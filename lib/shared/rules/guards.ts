 ...
 * Fichier : /lib/shared/rules/guards.ts
 * =======================================================*/

// Correction : Import relatif
import type { ClientData } from "../core/types";
...
export function hasEnfantMoins18At(client: ClientData, ref: Date): boolean {
  ...
  // Correction : ajout du type (any) ou (e: {Enter_dateNaissance: string}) pour TS
  return client.Enter_enfants.some((e: any) => computeAgeOn(e.Enter_dateNaissance, ref) < 18);
}
