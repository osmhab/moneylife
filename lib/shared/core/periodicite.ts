// lib/shared/core/periodicite.ts
//
...
//
// ⚠️ Copie miroir de `app/lib/core/periodicite.ts` — alimente la Cloud Function.
// Toute évolution doit être reportée dans les DEUX fichiers.
