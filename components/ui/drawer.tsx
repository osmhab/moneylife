...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 mt-24 rounded-t-xl border bg-background shadow-lg outline-none",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
...
const DrawerHeader = ({
  ...
  <div className={cn("mb-3 space-y-1.5 text-left", className)} {...props} />
);
