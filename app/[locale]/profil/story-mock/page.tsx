...
function StickyHeader({
  ...
  return (
    <div className="sticky top-0 z-20 w-full bg-white/80 dark:bg-zinc-950/80 backdrop-blur">
      {/* BARRE HEADER – full width */}
      <div className="relative h-[64px] flex items-center">
        {/* ⬅️ GAUCHE – plein écran */}
        <div className="absolute left-0 inset-y-0 flex items-center pl-4">
          <Link
            href="/dashboard"
            className="text-sm font-medium flex items-center gap-2 hover:opacity-80 transition"
      ...
      <motion.div style={{ width: progressWidth }} className="h-[2px]">
        <div
