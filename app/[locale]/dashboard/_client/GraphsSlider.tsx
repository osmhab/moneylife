//app/dashboard/_client/GraphsSlider.tsx
...
export default function GraphsSlider({ targetUid }: { targetUid?: string }) {
  const slides = [
    {
      id: "invalidite",
      label: "Invalidité",
      component: <InvalidityAreaChart targetUid={targetUid} />,
    },
    {
      id: "deces",
      label: "Décès",
      component: <DeathAreaChart targetUid={targetUid} />,
    },
    {
      id: "retraite",
      label: "Retraite",
      component: <RetirementAreaChart targetUid={targetUid} />,
    },
  ];
