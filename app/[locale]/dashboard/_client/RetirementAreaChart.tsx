...
export default function RetirementAreaChart({ targetUid }: { targetUid?: string }) {
    ...
    <Card className="h-full w-full border-0 bg-transparent shadow-none">
      ...
      <CardContent className="px-0 pb-0">
        ...
        <p className="mt-2 text-[11px] text-muted-foreground">
         Les chiffres affichés ici sont issus de calculs de lois (AVS) combinés aux données de votre certificat de caisse pension.
