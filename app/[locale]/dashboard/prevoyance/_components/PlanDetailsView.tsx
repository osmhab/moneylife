              ...
              <>
                ...
                <section className="space-y-3">
                  ...
                  <div className="bg-white rounded-[32px] overflow-hidden shadow-sm border border-slate-50">
                    ...
                    <DetailRow icon={<Coins className="text-emerald-300" />} label={t("labels.death_only_accident")} value={formatCHF(d.Enter_CapitalAucuneRenteAcc)} onClick={getEditAction(t("labels.death_only_accident"), d.Enter_CapitalAucuneRenteAcc, "data.Enter_CapitalAucuneRenteAcc")} mandatory />
                    <DetailRow icon={<Coins className="text-emerald-500" />} label={t("labels.death_independent_illness")} value={formatCHF(d.Enter_CapitalDecesIndependantMal)} onClick={getEditAction(t("labels.death_independent_illness"), d.Enter_CapitalDecesIndependantMal, "data.Enter_CapitalDecesIndependantMal")} />
                    <DetailRow icon={<Coins className="text-emerald-300" />} label={t("labels.death_independent_accident")} value={formatCHF(d.Enter_CapitalDecesIndependantAcc)} onClick={getEditAction(t("labels.death_independent_accident"), d.Enter_CapitalDecesIndependantAcc, "data.Enter_CapitalDecesIndependantAcc")} last />
                  </div>
                </section>
