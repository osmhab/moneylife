...
const TEXT_FIELDS = [
  ...
  "Enter_dateNaissance", "Enter_adresseCaisse", "Enter_employeur", "Enter_adresseEmployeur", "Enter_nomCaisseComplet", "Enter_nomPlan",
];
...
4. DEUX NOMS DIFFÉRENTS, À NE JAMAIS CONFONDRE.

   "Enter_nomCaisseComplet" = l'INSTITUTION qui assure, telle qu'imprimée :
   « AXA Fondation LPP Suisse romande », « Pensionskasse MOBIL », « Caisse de
   prévoyance du Canton du Valais – Caisse ouverte CPO ». C'est elle qui édite
   le règlement. Recopie l'intitulé complet, sans le raccourcir et sans le
   ramener à la liste ci-dessus. Beaucoup de fondations gèrent PLUSIEURS caisses
   distinctes, chacune avec son règlement : réduire « Caisse ouverte CPO » et
   « Caisse fermée CPF » à « CPVAL » rend impossible de savoir quelles règles
   s'appliquent à cet assuré.

   "Enter_nomPlan" = la VARIANTE de plan à l'intérieur de cette institution :
   « Plan B », « Plan de base », « Plan cadres ». C'est elle qui désigne
   l'annexe applicable du règlement. Ce n'est PAS le nom de la caisse.

   Si le document ne porte que l'un des deux, laisse l'autre vide plutôt que d'y
   recopier le premier : les confondre ferait appliquer à l'assuré l'annexe d'un
   autre plan.
